...
CREATE TABLE `historial_asignacion` (
  ...
  CONSTRAINT `historial_asignacion_chk_1` CHECK ((`kilometraje_final` >= `kilometraje_inicial`))
...
CREATE TABLE `historial_envio` (
  ...
  CONSTRAINT `historial_envio_ibfk_3` FOREIGN KEY (`id_repartidor`) REFERENCES `usuario` (`id_usuario`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `paquete` (
  ...
  `dimensiones` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
...
-- Dump completed on 2024-09-16  2:57:01
